...
| limma        |❶voom counts(vCounts)<br>❷DMRs(CPM/limma-trend,vCounts/limma-voom)| 3.42.0 |❶H4H-R/4.0.1<br>❷RStudio | R  |                            | https://bioconductor.org/packages/release/bioc/html/limma.html  |
